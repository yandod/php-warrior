...
$this->tip("Use warrior.listen to find spaces with other units, and warrior.direction_of to determine what direction they're in.");
$this->clue("Walk towards an enemy or captive with warrior.walk!);(warrior.direction_of(warrior.listen.first)), once warrior.listen.empty? then head for the stairs."
